    ...
    <?php
        ...
        for($i = 0; $i < number($_POST['method']) ; $i++){
            ...
            echo ("
                ...
                Popielniczka w pokoju <input type='checkbox' name='pal[]' value='true'/> <br>
                Klimatyzacja w pokoju <input type='checkbox' name='klima[]' value='true'/> <br>
            <br>            
");
        }
        echo("
        Dziecięce łóżko <input type='checkbox' name='dziecko' value='true'/> <br>
        Data przyjazdu <br>
